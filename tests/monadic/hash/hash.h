...
assoc_lookup(F0 &&eqb, const T1 k,
  ...
  return std::visit(
      Overloaded{
          [&](const list::nil<std::pair<T1, T2>> _args) -> std::optional<T2> {
            return std::nullopt;
          },
          [&](const list::cons<std::pair<T1, T2>> _args) -> std::optional<T2> {
...
template <typename T1, typename T2, MapsTo<bool, T1, T1> F0>
std::shared_ptr<list::list<std::pair<T1, T2>>> assoc_insert_or_replace(
    F0 &&eqb, const T1 k, const T2 v,
    const std::shared_ptr<list::list<std::pair<T1, T2>>> xs) {
  return std::visit(
      Overloaded{
          [&](const list::nil<std::pair<T1, T2>> _args)
          ...
          [&](const list::cons<std::pair<T1, T2>> _args)
              -> std::shared_ptr<list::list<std::pair<T1, T2>>> {
            std::pair<T1, T2> p = _args._a0;
            std::shared_ptr<list::list<std::pair<T1, T2>>> tl = _args._a1;
            T1 k_ = p.first;
...
std::optional<T2> stm_get(const std::shared_ptr<CHT<T1, T2>> t, const T1 k) {
  std::shared_ptr<stm::TVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>> b =
      bucket_of<T1, T2>(t, k);
...
template <typename T1, typename T2>
std::optional<T2> stm_delete(const std::shared_ptr<CHT<T1, T2>> t, const T1 k) {
  std::shared_ptr<stm::TVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>> b =
      bucket_of<T1, T2>(t, k);
  std::shared_ptr<list::list<std::pair<T1, T2>>> xs =
      stm::readTVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>(b);
  ...
  if (p.first.has_value()) {
    T2 _x = *p.first;
    stm::writeTVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>(b, p.second);
    return p.first;
  } else {
    return p.first;
  }
...
template <typename T1, typename T2>
T2 stm_get_or(const std::shared_ptr<CHT<T1, T2>> t, const T1 k, const T2 dflt) {
...
mk_buckets(const int num) {
  ...
  std::function<std::vector<std::shared_ptr<
      stm::TVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>>>(unsigned int)>
      f;
  f = [&](unsigned int n)
      -> std::vector<std::shared_ptr<
          stm::TVar<std::shared_ptr<list::list<std::pair<T1, T2>>>>>> {
...
template <typename T1, typename T2, MapsTo<bool, T1, T1> F0, MapsTo<int, T1> F1>
