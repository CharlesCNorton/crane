...
(* Behavioral candidate: INC on an odd register changes only the low nibble of its pair. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module IncModifiesSingleNibbleOdd.
...
End IncModifiesSingleNibbleOdd.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "inc_modifies_single_nibble_odd" IncModifiesSingleNibbleOdd.
