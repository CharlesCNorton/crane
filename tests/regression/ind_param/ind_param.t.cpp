...
int main() {
  // Test 1: test_size_single - should be 1 (single element container)
  {
    ...
    ASSERT(result == 1);
    std::cout << "Test 1 (single element size): " << result
              << " (expected 1): PASSED" << std::endl;
  }
  ...
  // Test 2: test_size_pair - should be 2 (pair container)
  {
    ...
    ASSERT(result == 2);
    std::cout << "Test 2 (pair size): " << result << " (expected 2): PASSED"
              << std::endl;
  }
  ...
  // Test 3: test_error - should be 0 (error result has no container)
  {
    ...
    ASSERT(result == 0);
    std::cout << "Test 3 (error result size): " << result
              << " (expected 0): PASSED" << std::endl;
  }
