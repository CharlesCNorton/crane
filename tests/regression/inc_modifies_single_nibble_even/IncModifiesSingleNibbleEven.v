...
(* Behavioral candidate: INC on an even register changes only the high nibble of its pair. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module IncModifiesSingleNibbleEven.
...
End IncModifiesSingleNibbleEven.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "inc_modifies_single_nibble_even" IncModifiesSingleNibbleEven.
