...
(* Behavioral candidate: setting an odd register changes the low nibble of its pair. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetRegAffectsPairLow.
...
Definition t : bool :=
  Nat.eqb (get_reg_pair (set_reg sample 3 12) 3) (get_reg sample 2 * 16 + 12).

End SetRegAffectsPairLow.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_reg_affects_pair_low" SetRegAffectsPairLow.
