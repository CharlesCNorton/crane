...
(* Behavioral candidate: set_prom then WPM preserves the selected bank bound. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesBankBound.
...
Definition t : bool := Nat.ltb (cur_bank after) 8.

End SetPromThenWpmPreservesBankBound.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_bank_bound" SetPromThenWpmPreservesBankBound.
