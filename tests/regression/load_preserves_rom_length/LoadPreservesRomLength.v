...
(* Behavioral candidate: loading a whole byte list preserves ROM length. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module LoadPreservesRomLength.
...
Definition after : state := load_program sample 1 [99; 88; 77].
Definition t : bool := Nat.eqb (length (rom after)) 4.

End LoadPreservesRomLength.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "load_preserves_rom_length" LoadPreservesRomLength.
