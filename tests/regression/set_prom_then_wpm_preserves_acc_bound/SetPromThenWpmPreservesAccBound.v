...
(* Behavioral candidate: set_prom then WPM preserves accumulator bounds. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesAccBound.
...
Definition t : bool := Nat.ltb (acc after) 16.

End SetPromThenWpmPreservesAccBound.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_acc_bound" SetPromThenWpmPreservesAccBound.
