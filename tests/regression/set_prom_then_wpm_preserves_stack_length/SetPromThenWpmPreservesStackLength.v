...
(* Behavioral candidate: set_prom then WPM preserves stack length. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesStackLength.
...
Definition t : bool := Nat.leb (length (stack after)) 3.

End SetPromThenWpmPreservesStackLength.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_stack_length" SetPromThenWpmPreservesStackLength.
