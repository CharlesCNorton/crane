...
(* Behavioral candidate: setting a register pair exposes the low nibble through get_reg. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetRegPairGetRegLow.
...
Definition t : bool := Nat.eqb (get_reg (set_reg_pair sample 2 171) 3) 11.

End SetRegPairGetRegLow.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_reg_pair_get_reg_low" SetRegPairGetRegLow.
