...
(* Behavioral candidate: XCH on an even register changes only the high nibble of its pair. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module XchModifiesSingleNibbleEven.
...
End XchModifiesSingleNibbleEven.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "xch_modifies_single_nibble_even" XchModifiesSingleNibbleEven.
