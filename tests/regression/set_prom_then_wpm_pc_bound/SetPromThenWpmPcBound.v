...
(* Behavioral candidate: set_prom then WPM leaves the program counter bounded. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPcBound.
...
Definition t : bool := Nat.ltb (pc after) 4096.

End SetPromThenWpmPcBound.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_pc_bound" SetPromThenWpmPcBound.
