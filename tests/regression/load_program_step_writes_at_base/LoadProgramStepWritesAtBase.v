...
(* Behavioral candidate: a single PROM programming step writes the byte at the base address. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module LoadProgramStepWritesAtBase.
...
Definition t : bool := Nat.eqb (nth 1 (rom after) 0) 99.

End LoadProgramStepWritesAtBase.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "load_program_step_writes_at_base" LoadProgramStepWritesAtBase.
