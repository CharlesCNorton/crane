...
(* Behavioral candidate: loading an empty program leaves ROM unchanged. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module LoadProgramNil.
...
Definition after : state := load_program sample 1 [].
Definition t : bool :=
...
Crane Extraction "load_program_nil" LoadProgramNil.
