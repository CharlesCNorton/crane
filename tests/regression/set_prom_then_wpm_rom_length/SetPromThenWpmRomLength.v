...
(* Behavioral candidate: set_prom then WPM preserves ROM length. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmRomLength.
...
Definition t : bool := Nat.eqb (length (rom after)) 8.

End SetPromThenWpmRomLength.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_rom_length" SetPromThenWpmRomLength.
