...
(* Consolidated from get_stat_bound_prop and init_is_reset_with_cleared_memory_prop. *)
(* Tests RAM state operations: get_stat, reset_state, and related helpers. *)
...
Definition t : nat :=
  get_stat empty_reg 2 + state_acc (reset_state cleared_state).

End RamStateOps.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_state_ops" RamStateOps.
