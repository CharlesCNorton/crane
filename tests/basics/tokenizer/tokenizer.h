  ...
  return std::visit(
      Overloaded{
          ...
          [&](const list::cons<T1> _args) -> std::shared_ptr<list::list<T1>> {
            ...
            return app<T1>(rev<T1>(l_),
                           list::cons<T1>::make(x, list::nil<T1>::make()));
          }},
      *l);
}
...
template <typename T1>
std::vector<T1> list_to_vec_h(const std::shared_ptr<list::list<T1>> l) {
  return std::visit(
      Overloaded{
          [&](const list::nil<T1> _args) -> std::vector<T1> { return {}; },
          [&](const list::cons<T1> _args) -> std::vector<T1> {
            T1 a = _args._a0;
            std::shared_ptr<list::list<T1>> l_ = _args._a1;
...
template <typename T1>
std::vector<T1> list_to_vec(const std::shared_ptr<list::list<T1>> l) {
  return list_to_vec_h<T1>(rev<T1>(l));
}

template <typename T1, typename T2, MapsTo<T2, T1> F0>
std::vector<T2> list_to_vec_map_h(F0 &&f,
                                  const std::shared_ptr<list::list<T1>> l) {
  return std::visit(
      Overloaded{
          [&](const list::nil<T1> _args) -> std::vector<T2> { return {}; },
          [&](const list::cons<T1> _args) -> std::vector<T2> {
            T1 a = _args._a0;
            std::shared_ptr<list::list<T1>> l_ = _args._a1;
...
template <typename T1, typename T2, MapsTo<T2, T1> F0>
std::vector<T2> list_to_vec_map(F0 &&f,
                                const std::shared_ptr<list::list<T1>> l) {
