...
int main() {
  ...
  //         size = 1 (for Node) + 1 (Leaf 1) + 1 (Leaf 2) = 3
  {
    ...
    ASSERT(result == 3);
    std::cout << "Test 1 (tree size): " << result << " (expected 3): PASSED"
              << std::endl;
  }
  ...
  //         size = 1 + 1 = 2
  {
    ...
    ASSERT(result == 2);
    std::cout << "Test 2 (forest size): " << result << " (expected 2): PASSED"
              << std::endl;
  }
  ...
  //         sum = 0 + 1 + 2 = 3
  {
    ...
    ASSERT(result == 3);
    std::cout << "Test 3 (tree sum): " << result << " (expected 3): PASSED"
              << std::endl;
  }
