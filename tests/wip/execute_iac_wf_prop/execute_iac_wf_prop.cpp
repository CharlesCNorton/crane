...
unsigned int
ExecuteIacWfProp::get_reg(const std::shared_ptr<ExecuteIacWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteIacWfProp::set_reg(const std::shared_ptr<ExecuteIacWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteIacWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteIacWfProp::get_pair(const std::shared_ptr<ExecuteIacWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteIacWfProp::set_pair(const std::shared_ptr<ExecuteIacWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteIacWfProp::push_return(std::shared_ptr<ExecuteIacWfProp::state> s,
...
std::shared_ptr<ExecuteIacWfProp::state>
ExecuteIacWfProp::execute(std::shared_ptr<ExecuteIacWfProp::state> s,
                          const std::shared_ptr<ExecuteIacWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteIacWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIacWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteIacWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIacWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteIacWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteIacWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIacWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIacWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIacWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIacWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            return std::make_shared<ExecuteIacWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIacWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteIacWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteIacWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
          ...
          [&](const typename ExecuteIacWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIacWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteIacWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(
          ...
          [&](const typename ExecuteIacWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIacWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteIacWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteIacWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteIacWfProp::state> {
