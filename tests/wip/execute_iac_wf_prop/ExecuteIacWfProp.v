...
(* Behavioral candidate: execute preserves WF for IAC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteIacWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample IAC).

End ExecuteIacWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_iac_wf_prop" ExecuteIacWfProp.
