...
struct Sort {
  ...
  static std::pair<std::shared_ptr<List::list<T1>>,
                   std::shared_ptr<List::list<T1>>>
  ...
  template <typename T1, typename T2,
            ...
            MapsTo<T2, T1> F3>
  static T2 div_conq_split(const T2 x,
                           const std::shared_ptr<List::list<T1>> &_x0, F2 &&_x1,
                           F3 &&_x2) {
    return [&](const std::function<T2(T1)> _x0,
               const std::function<T2(std::shared_ptr<List::list<T1>>, T2, T2)>
                   _x1,
            ...
            [&](const typename List::list<T1>::cons _args)
              ...
              return x0(
                  ...
                  div_conq_pivot<T1, T2>(
                      le_dec0, x, x0, split_pivot<T1>(le_dec0, a, l0).second));
            }},
        l->v());
  }
