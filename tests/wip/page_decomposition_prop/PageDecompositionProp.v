...
(* Behavioral candidate: a concrete address decomposes into page base plus offset. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PageDecompositionProp.
...
Definition t : Prop :=
  addr12_of_nat p_small = page_base p_small + (p_small mod 256).

End PageDecompositionProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "page_decomposition_prop" PageDecompositionProp.
