...
unsigned int
ExecuteStcWfProp::get_reg(const std::shared_ptr<ExecuteStcWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteStcWfProp::set_reg(const std::shared_ptr<ExecuteStcWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteStcWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteStcWfProp::get_pair(const std::shared_ptr<ExecuteStcWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteStcWfProp::set_pair(const std::shared_ptr<ExecuteStcWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteStcWfProp::push_return(std::shared_ptr<ExecuteStcWfProp::state> s,
...
std::shared_ptr<ExecuteStcWfProp::state>
ExecuteStcWfProp::execute(std::shared_ptr<ExecuteStcWfProp::state> s,
                          const std::shared_ptr<ExecuteStcWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteStcWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteStcWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteStcWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteStcWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteStcWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteStcWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteStcWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteStcWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteStcWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteStcWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            return std::make_shared<ExecuteStcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteStcWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteStcWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteStcWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
          ...
          [&](const typename ExecuteStcWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteStcWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteStcWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(
          ...
          [&](const typename ExecuteStcWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteStcWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteStcWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteStcWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteStcWfProp::state> {
