...
(* Behavioral candidate: execute preserves WF for STC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteStcWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample STC).

End ExecuteStcWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_stc_wf_prop" ExecuteStcWfProp.
