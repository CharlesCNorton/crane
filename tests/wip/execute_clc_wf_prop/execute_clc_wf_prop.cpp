...
unsigned int
ExecuteClcWfProp::get_reg(const std::shared_ptr<ExecuteClcWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteClcWfProp::set_reg(const std::shared_ptr<ExecuteClcWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteClcWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteClcWfProp::get_pair(const std::shared_ptr<ExecuteClcWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteClcWfProp::set_pair(const std::shared_ptr<ExecuteClcWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteClcWfProp::push_return(std::shared_ptr<ExecuteClcWfProp::state> s,
...
std::shared_ptr<ExecuteClcWfProp::state>
ExecuteClcWfProp::execute(std::shared_ptr<ExecuteClcWfProp::state> s,
                          const std::shared_ptr<ExecuteClcWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteClcWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClcWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteClcWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteClcWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteClcWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteClcWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClcWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClcWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClcWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteClcWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            return std::make_shared<ExecuteClcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteClcWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteClcWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteClcWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
          ...
          [&](const typename ExecuteClcWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteClcWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteClcWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(
          ...
          [&](const typename ExecuteClcWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClcWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteClcWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteClcWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteClcWfProp::state> {
