...
(* Behavioral candidate: execute preserves WF for CLC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteClcWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample CLC).

End ExecuteClcWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_clc_wf_prop" ExecuteClcWfProp.
