...
(* Behavioral candidate: CLB clears ACC and carry on the sample state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ClbClearsVolatileProp.
...
Definition t : Prop :=
  ex_acc (execute sample CLB) = 0 /\
  ex_carry (execute sample CLB) = false.

End ClbClearsVolatileProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "clb_clears_volatile_prop" ClbClearsVolatileProp.
