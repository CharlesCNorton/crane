...
unsigned int
ExecuteCmcWfProp::get_reg(const std::shared_ptr<ExecuteCmcWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteCmcWfProp::set_reg(const std::shared_ptr<ExecuteCmcWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteCmcWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteCmcWfProp::get_pair(const std::shared_ptr<ExecuteCmcWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteCmcWfProp::set_pair(const std::shared_ptr<ExecuteCmcWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteCmcWfProp::push_return(std::shared_ptr<ExecuteCmcWfProp::state> s,
...
std::shared_ptr<ExecuteCmcWfProp::state>
ExecuteCmcWfProp::execute(std::shared_ptr<ExecuteCmcWfProp::state> s,
                          const std::shared_ptr<ExecuteCmcWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteCmcWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmcWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteCmcWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteCmcWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteCmcWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteCmcWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmcWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmcWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmcWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteCmcWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteCmcWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteCmcWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteCmcWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
          ...
          [&](const typename ExecuteCmcWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteCmcWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteCmcWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(
          ...
          [&](const typename ExecuteCmcWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmcWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteCmcWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteCmcWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteCmcWfProp::state> {
