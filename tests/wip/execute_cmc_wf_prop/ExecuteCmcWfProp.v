...
(* Behavioral candidate: execute preserves WF for CMC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteCmcWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample CMC).

End ExecuteCmcWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_cmc_wf_prop" ExecuteCmcWfProp.
