...
(* Behavioral candidate: NOP advances PC by one modulo the 12-bit address space. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeNopProp.
...
Definition t : Prop :=
  ex_pc (execute sample NOP) = (ex_pc sample + 1) mod 4096.

End PcShapeNopProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_nop_prop" PcShapeNopProp.
