...
unsigned int
PcShapeNopProp::get_reg(const std::shared_ptr<PcShapeNopProp::state> &s,
                        const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PcShapeNopProp::set_reg(const std::shared_ptr<PcShapeNopProp::state> &s,
                        const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeNopProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PcShapeNopProp::get_pair(const std::shared_ptr<PcShapeNopProp::state> &s,
                         const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PcShapeNopProp::set_pair(const std::shared_ptr<PcShapeNopProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PcShapeNopProp::push_return(std::shared_ptr<PcShapeNopProp::state> s,
...
std::shared_ptr<PcShapeNopProp::state>
PcShapeNopProp::execute(std::shared_ptr<PcShapeNopProp::state> s,
                        const std::shared_ptr<PcShapeNopProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeNopProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeNopProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeNopProp::instr::LD _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeNopProp::instr::INC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeNopProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeNopProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeNopProp::instr::STC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeNopProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeNopProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeNopProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            return std::make_shared<PcShapeNopProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeNopProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeNopProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeNopProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
          ...
          [&](const typename PcShapeNopProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeNopProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeNopProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(
          ...
          [&](const typename PcShapeNopProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeNopProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeNopProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeNopProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeNopProp::state> {
