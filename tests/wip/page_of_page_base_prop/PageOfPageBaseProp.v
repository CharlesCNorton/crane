...
(* Behavioral candidate: page_of the page base agrees with the original page. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PageOfPageBaseProp.
...
Definition t : Prop :=
  page_of (page_base p_small) = page_of p_small.

End PageOfPageBaseProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "page_of_page_base_prop" PageOfPageBaseProp.
