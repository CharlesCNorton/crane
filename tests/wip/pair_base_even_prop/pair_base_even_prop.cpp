...
unsigned int
PairBaseEvenProp::get_reg(const std::shared_ptr<PairBaseEvenProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PairBaseEvenProp::set_reg(const std::shared_ptr<PairBaseEvenProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PairBaseEvenProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PairBaseEvenProp::get_pair(const std::shared_ptr<PairBaseEvenProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PairBaseEvenProp::set_pair(const std::shared_ptr<PairBaseEvenProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PairBaseEvenProp::push_return(std::shared_ptr<PairBaseEvenProp::state> s,
...
std::shared_ptr<PairBaseEvenProp::state>
PairBaseEvenProp::execute(std::shared_ptr<PairBaseEvenProp::state> s,
                          const std::shared_ptr<PairBaseEvenProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PairBaseEvenProp::instr::NOP _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseEvenProp::instr::LDM _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PairBaseEvenProp::instr::LD _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::XCH _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairBaseEvenProp::instr::INC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::ADD _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PairBaseEvenProp::instr::SUB _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PairBaseEvenProp::instr::IAC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::DAC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::CLC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseEvenProp::instr::STC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseEvenProp::instr::CMC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::CMA _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::CLB _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseEvenProp::instr::RAL _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::RAR _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::TCC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairBaseEvenProp::instr::TCS _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            return std::make_shared<PairBaseEvenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairBaseEvenProp::instr::DAA _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PairBaseEvenProp::instr::KBP _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::JUN _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::JMS _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PairBaseEvenProp::instr::JCN _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
          ...
          [&](const typename PairBaseEvenProp::instr::FIM _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairBaseEvenProp::instr::SRC _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PairBaseEvenProp::instr::FIN _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(
          ...
          [&](const typename PairBaseEvenProp::instr::JIN _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseEvenProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PairBaseEvenProp::instr::ISZ _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PairBaseEvenProp::instr::BBL _args)
              -> std::shared_ptr<PairBaseEvenProp::state> {
