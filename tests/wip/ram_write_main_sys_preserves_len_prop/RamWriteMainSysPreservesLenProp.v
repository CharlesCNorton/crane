...
(* Behavioral candidate: ram_write_main_sys preserves the number of RAM banks. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RamWriteMainSysPreservesLenProp.
...
Definition t : Prop :=
  length (ram_write_main_sys init_state 12) = 4.

End RamWriteMainSysPreservesLenProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_write_main_sys_preserves_len_prop" RamWriteMainSysPreservesLenProp.
