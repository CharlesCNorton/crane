...
(* Behavioral candidate: set_prom then WPM preserves the selected ROM bound. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesSelRomBound.
...
Definition t : bool := Nat.ltb (sel_rom after) 16.

End SetPromThenWpmPreservesSelRomBound.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_sel_rom_bound" SetPromThenWpmPreservesSelRomBound.
