...
(* Behavioral candidate: execute preserves WF for TCS. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteTcsWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample TCS).

End ExecuteTcsWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_tcs_wf_prop" ExecuteTcsWfProp.
