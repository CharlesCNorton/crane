...
(* Behavioral candidate: execute preserves WF for FIM. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteFimWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (FIM 4 171) /\
  WF (execute sample (FIM 4 171)).

End ExecuteFimWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_fim_wf_prop" ExecuteFimWfProp.
