...
unsigned int
ExecuteJinWfProp::get_reg(const std::shared_ptr<ExecuteJinWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteJinWfProp::set_reg(const std::shared_ptr<ExecuteJinWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteJinWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteJinWfProp::get_pair(const std::shared_ptr<ExecuteJinWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteJinWfProp::set_pair(const std::shared_ptr<ExecuteJinWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteJinWfProp::push_return(std::shared_ptr<ExecuteJinWfProp::state> s,
...
std::shared_ptr<ExecuteJinWfProp::state>
ExecuteJinWfProp::execute(std::shared_ptr<ExecuteJinWfProp::state> s,
                          const std::shared_ptr<ExecuteJinWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteJinWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJinWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteJinWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJinWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteJinWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteJinWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJinWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJinWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJinWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJinWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            return std::make_shared<ExecuteJinWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJinWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteJinWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteJinWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
          ...
          [&](const typename ExecuteJinWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJinWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteJinWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(
          ...
          [&](const typename ExecuteJinWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJinWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteJinWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteJinWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteJinWfProp::state> {
