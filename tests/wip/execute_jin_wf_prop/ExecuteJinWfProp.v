...
(* Behavioral candidate: execute preserves WF for JIN. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteJinWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (JIN 10) /\
  WF (execute sample (JIN 10)).

End ExecuteJinWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_jin_wf_prop" ExecuteJinWfProp.
