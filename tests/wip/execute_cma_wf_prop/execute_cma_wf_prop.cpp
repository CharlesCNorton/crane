...
unsigned int
ExecuteCmaWfProp::get_reg(const std::shared_ptr<ExecuteCmaWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteCmaWfProp::set_reg(const std::shared_ptr<ExecuteCmaWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteCmaWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteCmaWfProp::get_pair(const std::shared_ptr<ExecuteCmaWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteCmaWfProp::set_pair(const std::shared_ptr<ExecuteCmaWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteCmaWfProp::push_return(std::shared_ptr<ExecuteCmaWfProp::state> s,
...
std::shared_ptr<ExecuteCmaWfProp::state>
ExecuteCmaWfProp::execute(std::shared_ptr<ExecuteCmaWfProp::state> s,
                          const std::shared_ptr<ExecuteCmaWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteCmaWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmaWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteCmaWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteCmaWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteCmaWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteCmaWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmaWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmaWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteCmaWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteCmaWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteCmaWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteCmaWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteCmaWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
          ...
          [&](const typename ExecuteCmaWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteCmaWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteCmaWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(
          ...
          [&](const typename ExecuteCmaWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteCmaWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteCmaWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteCmaWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteCmaWfProp::state> {
