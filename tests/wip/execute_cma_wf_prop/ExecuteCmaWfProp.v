...
(* Behavioral candidate: execute preserves WF for CMA. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteCmaWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample CMA).

End ExecuteCmaWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_cma_wf_prop" ExecuteCmaWfProp.
