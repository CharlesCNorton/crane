...
unsigned int
PairBaseOddProp::get_reg(const std::shared_ptr<PairBaseOddProp::state> &s,
                         const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PairBaseOddProp::set_reg(const std::shared_ptr<PairBaseOddProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PairBaseOddProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PairBaseOddProp::get_pair(const std::shared_ptr<PairBaseOddProp::state> &s,
                          const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PairBaseOddProp::set_pair(const std::shared_ptr<PairBaseOddProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PairBaseOddProp::push_return(std::shared_ptr<PairBaseOddProp::state> s,
...
std::shared_ptr<PairBaseOddProp::state>
PairBaseOddProp::execute(std::shared_ptr<PairBaseOddProp::state> s,
                         const std::shared_ptr<PairBaseOddProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PairBaseOddProp::instr::NOP _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseOddProp::instr::LDM _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PairBaseOddProp::instr::LD _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::XCH _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairBaseOddProp::instr::INC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::ADD _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PairBaseOddProp::instr::SUB _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PairBaseOddProp::instr::IAC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::DAC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::CLC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseOddProp::instr::STC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseOddProp::instr::CMC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::CMA _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::CLB _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairBaseOddProp::instr::RAL _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::RAR _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::TCC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairBaseOddProp::instr::TCS _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            return std::make_shared<PairBaseOddProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairBaseOddProp::instr::DAA _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PairBaseOddProp::instr::KBP _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::JUN _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::JMS _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PairBaseOddProp::instr::JCN _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
          ...
          [&](const typename PairBaseOddProp::instr::FIM _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairBaseOddProp::instr::SRC _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PairBaseOddProp::instr::FIN _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(
          ...
          [&](const typename PairBaseOddProp::instr::JIN _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairBaseOddProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PairBaseOddProp::instr::ISZ _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PairBaseOddProp::instr::BBL _args)
              -> std::shared_ptr<PairBaseOddProp::state> {
