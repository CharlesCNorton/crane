...
unsigned int
ExecuteXchWfProp::get_reg(const std::shared_ptr<ExecuteXchWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteXchWfProp::set_reg(const std::shared_ptr<ExecuteXchWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteXchWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteXchWfProp::get_pair(const std::shared_ptr<ExecuteXchWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteXchWfProp::set_pair(const std::shared_ptr<ExecuteXchWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteXchWfProp::push_return(std::shared_ptr<ExecuteXchWfProp::state> s,
...
std::shared_ptr<ExecuteXchWfProp::state>
ExecuteXchWfProp::execute(std::shared_ptr<ExecuteXchWfProp::state> s,
                          const std::shared_ptr<ExecuteXchWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteXchWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteXchWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteXchWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteXchWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteXchWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteXchWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteXchWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteXchWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteXchWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteXchWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            return std::make_shared<ExecuteXchWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteXchWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteXchWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteXchWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
          ...
          [&](const typename ExecuteXchWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteXchWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteXchWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(
          ...
          [&](const typename ExecuteXchWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteXchWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteXchWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteXchWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteXchWfProp::state> {
