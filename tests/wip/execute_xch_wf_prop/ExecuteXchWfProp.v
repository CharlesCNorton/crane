...
(* Behavioral candidate: execute preserves WF for XCH. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteXchWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (XCH 8) /\
  WF (execute sample (XCH 8)).

End ExecuteXchWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_xch_wf_prop" ExecuteXchWfProp.
