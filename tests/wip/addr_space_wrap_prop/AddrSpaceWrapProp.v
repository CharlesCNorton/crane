...
(* Behavioral candidate: addr12_of_nat wraps one past the address-space ceiling to one. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module AddrSpaceWrapProp.
...
Definition t : Prop :=
  addr12_of_nat 4097 = 1.

End AddrSpaceWrapProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "addr_space_wrap_prop" AddrSpaceWrapProp.
