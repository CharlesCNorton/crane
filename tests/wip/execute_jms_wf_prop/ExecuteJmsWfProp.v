...
(* Behavioral candidate: execute preserves WF for JMS. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteJmsWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (JMS 2048) /\
  WF (execute sample (JMS 2048)).

End ExecuteJmsWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_jms_wf_prop" ExecuteJmsWfProp.
