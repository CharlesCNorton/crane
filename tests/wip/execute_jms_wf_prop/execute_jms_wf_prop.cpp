...
unsigned int
ExecuteJmsWfProp::get_reg(const std::shared_ptr<ExecuteJmsWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteJmsWfProp::set_reg(const std::shared_ptr<ExecuteJmsWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteJmsWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteJmsWfProp::get_pair(const std::shared_ptr<ExecuteJmsWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteJmsWfProp::set_pair(const std::shared_ptr<ExecuteJmsWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteJmsWfProp::push_return(std::shared_ptr<ExecuteJmsWfProp::state> s,
...
std::shared_ptr<ExecuteJmsWfProp::state>
ExecuteJmsWfProp::execute(std::shared_ptr<ExecuteJmsWfProp::state> s,
                          const std::shared_ptr<ExecuteJmsWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteJmsWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJmsWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteJmsWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJmsWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteJmsWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteJmsWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJmsWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJmsWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJmsWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJmsWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJmsWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteJmsWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteJmsWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
          ...
          [&](const typename ExecuteJmsWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJmsWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteJmsWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(
          ...
          [&](const typename ExecuteJmsWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJmsWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteJmsWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteJmsWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteJmsWfProp::state> {
