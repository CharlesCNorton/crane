...
(* Behavioral candidate: ram_write_status_sys preserves the number of RAM banks. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RamWriteStatusSysPreservesLenProp.
...
Definition t : Prop :=
  length (ram_write_status_sys init_state 2 7) = 4.

End RamWriteStatusSysPreservesLenProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_write_status_sys_preserves_len_prop" RamWriteStatusSysPreservesLenProp.
