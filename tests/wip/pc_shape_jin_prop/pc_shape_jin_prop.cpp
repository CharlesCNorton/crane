...
unsigned int
PcShapeJinProp::get_reg(const std::shared_ptr<PcShapeJinProp::state> &s,
                        const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PcShapeJinProp::set_reg(const std::shared_ptr<PcShapeJinProp::state> &s,
                        const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeJinProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PcShapeJinProp::get_pair(const std::shared_ptr<PcShapeJinProp::state> &s,
                         const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PcShapeJinProp::set_pair(const std::shared_ptr<PcShapeJinProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PcShapeJinProp::push_return(std::shared_ptr<PcShapeJinProp::state> s,
...
std::shared_ptr<PcShapeJinProp::state>
PcShapeJinProp::execute(std::shared_ptr<PcShapeJinProp::state> s,
                        const std::shared_ptr<PcShapeJinProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeJinProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJinProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeJinProp::instr::LD _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJinProp::instr::INC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeJinProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeJinProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJinProp::instr::STC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJinProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJinProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJinProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            return std::make_shared<PcShapeJinProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJinProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeJinProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeJinProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
          ...
          [&](const typename PcShapeJinProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJinProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeJinProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(
          ...
          [&](const typename PcShapeJinProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJinProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeJinProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeJinProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeJinProp::state> {
