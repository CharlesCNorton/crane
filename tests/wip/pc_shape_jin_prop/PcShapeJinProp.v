...
(* Behavioral candidate: JIN jumps to the normalized register-pair value. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeJinProp.
...
Definition t : Prop :=
  ex_pc (execute sample (JIN 10)) = get_pair sample 10 mod 4096.

End PcShapeJinProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_jin_prop" PcShapeJinProp.
