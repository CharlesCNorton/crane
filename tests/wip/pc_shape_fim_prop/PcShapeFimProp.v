...
(* Behavioral candidate: FIM advances PC by two. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeFimProp.
...
Definition t : Prop :=
  ex_pc (execute sample (FIM 4 171)) = (ex_pc sample + 2) mod 4096.

End PcShapeFimProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_fim_prop" PcShapeFimProp.
