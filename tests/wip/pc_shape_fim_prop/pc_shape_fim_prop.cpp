...
unsigned int
PcShapeFimProp::get_reg(const std::shared_ptr<PcShapeFimProp::state> &s,
                        const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PcShapeFimProp::set_reg(const std::shared_ptr<PcShapeFimProp::state> &s,
                        const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeFimProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PcShapeFimProp::get_pair(const std::shared_ptr<PcShapeFimProp::state> &s,
                         const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PcShapeFimProp::set_pair(const std::shared_ptr<PcShapeFimProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PcShapeFimProp::push_return(std::shared_ptr<PcShapeFimProp::state> s,
...
std::shared_ptr<PcShapeFimProp::state>
PcShapeFimProp::execute(std::shared_ptr<PcShapeFimProp::state> s,
                        const std::shared_ptr<PcShapeFimProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeFimProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeFimProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeFimProp::instr::LD _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeFimProp::instr::INC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeFimProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeFimProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeFimProp::instr::STC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeFimProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeFimProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeFimProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            return std::make_shared<PcShapeFimProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeFimProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeFimProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeFimProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
          ...
          [&](const typename PcShapeFimProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeFimProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeFimProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(
          ...
          [&](const typename PcShapeFimProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeFimProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeFimProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeFimProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeFimProp::state> {
