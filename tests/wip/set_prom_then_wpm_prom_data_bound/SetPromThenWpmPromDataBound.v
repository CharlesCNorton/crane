...
(* Behavioral candidate: set_prom then WPM preserves programmed data bounds. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPromDataBound.
...
Definition after : state := execute_wpm (set_prom_params sample 3 155 true).
Definition t : bool := Nat.ltb (prom_data after) 256.

End SetPromThenWpmPromDataBound.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_prom_data_bound" SetPromThenWpmPromDataBound.
