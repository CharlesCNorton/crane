...
(* Behavioral candidate: execute preserves WF for LDM. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteLdmWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (LDM 5) /\
  WF (execute sample (LDM 5)).

End ExecuteLdmWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_ldm_wf_prop" ExecuteLdmWfProp.
