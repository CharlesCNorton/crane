...
(* Behavioral candidate: execute preserves WF for INC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteIncWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (INC 5) /\
  WF (execute sample (INC 5)).

End ExecuteIncWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_inc_wf_prop" ExecuteIncWfProp.
