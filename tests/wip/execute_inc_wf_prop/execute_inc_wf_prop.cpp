...
unsigned int
ExecuteIncWfProp::get_reg(const std::shared_ptr<ExecuteIncWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteIncWfProp::set_reg(const std::shared_ptr<ExecuteIncWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteIncWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteIncWfProp::get_pair(const std::shared_ptr<ExecuteIncWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteIncWfProp::set_pair(const std::shared_ptr<ExecuteIncWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteIncWfProp::push_return(std::shared_ptr<ExecuteIncWfProp::state> s,
...
std::shared_ptr<ExecuteIncWfProp::state>
ExecuteIncWfProp::execute(std::shared_ptr<ExecuteIncWfProp::state> s,
                          const std::shared_ptr<ExecuteIncWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteIncWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIncWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteIncWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIncWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteIncWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteIncWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIncWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIncWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIncWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIncWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            return std::make_shared<ExecuteIncWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIncWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteIncWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteIncWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
          ...
          [&](const typename ExecuteIncWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIncWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteIncWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(
          ...
          [&](const typename ExecuteIncWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIncWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteIncWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteIncWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteIncWfProp::state> {
