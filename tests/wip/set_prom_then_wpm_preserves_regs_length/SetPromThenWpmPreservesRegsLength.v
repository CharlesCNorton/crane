...
(* Behavioral candidate: set_prom then WPM preserves register file length. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesRegsLength.
...
Definition t : bool := Nat.eqb (length (regs after)) 4.

End SetPromThenWpmPreservesRegsLength.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_regs_length" SetPromThenWpmPreservesRegsLength.
