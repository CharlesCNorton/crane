...
(* Behavioral candidate: execute preserves WF for ISZ. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteIszWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (ISZ 11 42) /\
  WF (execute sample (ISZ 11 42)).

End ExecuteIszWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_isz_wf_prop" ExecuteIszWfProp.
