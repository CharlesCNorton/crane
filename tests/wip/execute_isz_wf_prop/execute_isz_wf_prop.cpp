...
unsigned int
ExecuteIszWfProp::get_reg(const std::shared_ptr<ExecuteIszWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteIszWfProp::set_reg(const std::shared_ptr<ExecuteIszWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteIszWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteIszWfProp::get_pair(const std::shared_ptr<ExecuteIszWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteIszWfProp::set_pair(const std::shared_ptr<ExecuteIszWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteIszWfProp::push_return(std::shared_ptr<ExecuteIszWfProp::state> s,
...
std::shared_ptr<ExecuteIszWfProp::state>
ExecuteIszWfProp::execute(std::shared_ptr<ExecuteIszWfProp::state> s,
                          const std::shared_ptr<ExecuteIszWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteIszWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIszWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteIszWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIszWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteIszWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteIszWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIszWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIszWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteIszWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIszWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            return std::make_shared<ExecuteIszWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteIszWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteIszWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteIszWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
          ...
          [&](const typename ExecuteIszWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteIszWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteIszWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(
          ...
          [&](const typename ExecuteIszWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteIszWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteIszWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteIszWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteIszWfProp::state> {
