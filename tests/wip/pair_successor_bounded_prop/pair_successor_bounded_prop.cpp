...
#include <memory>
#include <optional>
#include <pair_successor_bounded_prop.h>
#include <stdexcept>
#include <string>
#include <utility>
#include <variant>

unsigned int PairSuccessorBoundedProp::get_reg(
    const std::shared_ptr<PairSuccessorBoundedProp::state> &s,
    const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>> PairSuccessorBoundedProp::set_reg(
    const std::shared_ptr<PairSuccessorBoundedProp::state> &s,
    const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PairSuccessorBoundedProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int PairSuccessorBoundedProp::get_pair(
    const std::shared_ptr<PairSuccessorBoundedProp::state> &s,
    const unsigned int r) {
...
std::shared_ptr<List<unsigned int>> PairSuccessorBoundedProp::set_pair(
    const std::shared_ptr<PairSuccessorBoundedProp::state> &s,
    const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>> PairSuccessorBoundedProp::push_return(
    std::shared_ptr<PairSuccessorBoundedProp::state> s,
...
std::shared_ptr<PairSuccessorBoundedProp::state>
PairSuccessorBoundedProp::execute(
    std::shared_ptr<PairSuccessorBoundedProp::state> s,
    const std::shared_ptr<PairSuccessorBoundedProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PairSuccessorBoundedProp::instr::NOP _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairSuccessorBoundedProp::instr::LDM _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PairSuccessorBoundedProp::instr::LD _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::XCH _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairSuccessorBoundedProp::instr::INC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::ADD _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PairSuccessorBoundedProp::instr::SUB _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PairSuccessorBoundedProp::instr::IAC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::DAC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::CLC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairSuccessorBoundedProp::instr::STC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairSuccessorBoundedProp::instr::CMC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::CMA _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::CLB _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PairSuccessorBoundedProp::instr::RAL _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::RAR _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::TCC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::TCS _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::DAA _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::KBP _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::JUN _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::JMS _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PairSuccessorBoundedProp::instr::JCN _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
          ...
          [&](const typename PairSuccessorBoundedProp::instr::FIM _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PairSuccessorBoundedProp::instr::SRC _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PairSuccessorBoundedProp::instr::FIN _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(
          ...
          [&](const typename PairSuccessorBoundedProp::instr::JIN _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PairSuccessorBoundedProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PairSuccessorBoundedProp::instr::ISZ _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PairSuccessorBoundedProp::instr::BBL _args)
              -> std::shared_ptr<PairSuccessorBoundedProp::state> {
