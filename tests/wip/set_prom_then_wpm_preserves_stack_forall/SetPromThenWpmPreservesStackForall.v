...
(* Behavioral candidate: set_prom then WPM preserves stack bounds. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesStackForall.
...
Definition t : Prop := Forall (fun a => a < 4096) (stack after).

End SetPromThenWpmPreservesStackForall.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_stack_forall" SetPromThenWpmPreservesStackForall.
