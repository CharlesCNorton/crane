...
(* Behavioral candidate: adding a bounded offset to a page base stays on the same page. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PageBasePlusOffsetSamePageProp.
...
Definition t : Prop :=
  page_of (page_base p_small + 9) = page_of p_small.

End PageBasePlusOffsetSamePageProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "page_base_plus_offset_same_page_prop" PageBasePlusOffsetSamePageProp.
