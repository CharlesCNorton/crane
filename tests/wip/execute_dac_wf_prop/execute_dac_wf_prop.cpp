...
unsigned int
ExecuteDacWfProp::get_reg(const std::shared_ptr<ExecuteDacWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteDacWfProp::set_reg(const std::shared_ptr<ExecuteDacWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteDacWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteDacWfProp::get_pair(const std::shared_ptr<ExecuteDacWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteDacWfProp::set_pair(const std::shared_ptr<ExecuteDacWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteDacWfProp::push_return(std::shared_ptr<ExecuteDacWfProp::state> s,
...
std::shared_ptr<ExecuteDacWfProp::state>
ExecuteDacWfProp::execute(std::shared_ptr<ExecuteDacWfProp::state> s,
                          const std::shared_ptr<ExecuteDacWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteDacWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDacWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteDacWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteDacWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteDacWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteDacWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDacWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDacWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDacWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteDacWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            return std::make_shared<ExecuteDacWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteDacWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteDacWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteDacWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
          ...
          [&](const typename ExecuteDacWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteDacWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteDacWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(
          ...
          [&](const typename ExecuteDacWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDacWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteDacWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteDacWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteDacWfProp::state> {
