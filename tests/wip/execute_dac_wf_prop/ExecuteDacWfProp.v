...
(* Behavioral candidate: execute preserves WF for DAC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteDacWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample DAC).

End ExecuteDacWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_dac_wf_prop" ExecuteDacWfProp.
