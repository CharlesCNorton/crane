...
(* Behavioral candidate: execute preserves WF for ADD. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteAddWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (ADD 4) /\
  WF (execute sample (ADD 4)).

End ExecuteAddWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_add_wf_prop" ExecuteAddWfProp.
