...
(* Behavioral candidate: ram_write_main_sys preserves WF_bank across the RAM system. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RamWriteMainSysPreservesWfBankProp.
...
Definition t : Prop :=
  Forall WF_bank (ram_write_main_sys init_state 12).

End RamWriteMainSysPreservesWfBankProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_write_main_sys_preserves_wf_bank_prop" RamWriteMainSysPreservesWfBankProp.
