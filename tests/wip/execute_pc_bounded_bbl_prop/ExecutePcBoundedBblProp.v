...
(* Behavioral candidate: execute keeps PC bounded for BBL on the sample state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecutePcBoundedBblProp.
...
Definition t : Prop :=
  ex_pc (execute sample (BBL 7)) < 4096.

End ExecutePcBoundedBblProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_pc_bounded_bbl_prop" ExecutePcBoundedBblProp.
