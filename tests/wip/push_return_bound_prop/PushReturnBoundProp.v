...
(* Behavioral candidate: push_return preserves concrete return-address bounds. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PushReturnBoundProp.
...
Definition t : Prop :=
  Forall (fun a => a < 4096) (push_return sample 77).

End PushReturnBoundProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "push_return_bound_prop" PushReturnBoundProp.
