...
#include <memory>
#include <optional>
#include <pc_shape_jcn_taken_prop.h>
#include <stdexcept>
#include <string>
#include <utility>
#include <variant>

unsigned int PcShapeJcnTakenProp::get_reg(
    const std::shared_ptr<PcShapeJcnTakenProp::state> &s,
    const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>> PcShapeJcnTakenProp::set_reg(
    const std::shared_ptr<PcShapeJcnTakenProp::state> &s, const unsigned int r,
    const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeJcnTakenProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int PcShapeJcnTakenProp::get_pair(
    const std::shared_ptr<PcShapeJcnTakenProp::state> &s,
    const unsigned int r) {
...
std::shared_ptr<List<unsigned int>> PcShapeJcnTakenProp::set_pair(
    const std::shared_ptr<PcShapeJcnTakenProp::state> &s, const unsigned int r,
    const unsigned int v) {
  unsigned int base = pair_base(r);
...
PcShapeJcnTakenProp::push_return(std::shared_ptr<PcShapeJcnTakenProp::state> s,
...
std::shared_ptr<PcShapeJcnTakenProp::state> PcShapeJcnTakenProp::execute(
    std::shared_ptr<PcShapeJcnTakenProp::state> s,
    const std::shared_ptr<PcShapeJcnTakenProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeJcnTakenProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnTakenProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeJcnTakenProp::instr::LD _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJcnTakenProp::instr::INC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeJcnTakenProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeJcnTakenProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnTakenProp::instr::STC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnTakenProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnTakenProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeJcnTakenProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
          ...
          [&](const typename PcShapeJcnTakenProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJcnTakenProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeJcnTakenProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(
          ...
          [&](const typename PcShapeJcnTakenProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnTakenProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeJcnTakenProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeJcnTakenProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeJcnTakenProp::state> {
