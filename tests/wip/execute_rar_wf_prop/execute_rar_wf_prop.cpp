...
unsigned int
ExecuteRarWfProp::get_reg(const std::shared_ptr<ExecuteRarWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteRarWfProp::set_reg(const std::shared_ptr<ExecuteRarWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteRarWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteRarWfProp::get_pair(const std::shared_ptr<ExecuteRarWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteRarWfProp::set_pair(const std::shared_ptr<ExecuteRarWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteRarWfProp::push_return(std::shared_ptr<ExecuteRarWfProp::state> s,
...
std::shared_ptr<ExecuteRarWfProp::state>
ExecuteRarWfProp::execute(std::shared_ptr<ExecuteRarWfProp::state> s,
                          const std::shared_ptr<ExecuteRarWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteRarWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRarWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteRarWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteRarWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteRarWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteRarWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRarWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRarWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRarWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteRarWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            return std::make_shared<ExecuteRarWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteRarWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteRarWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteRarWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
          ...
          [&](const typename ExecuteRarWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteRarWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteRarWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(
          ...
          [&](const typename ExecuteRarWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRarWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteRarWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteRarWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteRarWfProp::state> {
