...
(* Behavioral candidate: execute preserves WF for RAR. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteRarWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample RAR).

End ExecuteRarWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_rar_wf_prop" ExecuteRarWfProp.
