...
(* Behavioral candidate: LDM loads its immediate into ACC on the sample state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module LdmLoadsImmediateProp.
...
Definition t : Prop :=
  ex_acc (execute sample (LDM 5)) = 5.

End LdmLoadsImmediateProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ldm_loads_immediate_prop" LdmLoadsImmediateProp.
