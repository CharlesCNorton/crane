...
#include <functional>
#include <iostream>
#include <ldm_loads_immediate_prop.h>
#include <memory>
#include <optional>
#include <stdexcept>
#include <string>
...
unsigned int LdmLoadsImmediateProp::get_reg(
    const std::shared_ptr<LdmLoadsImmediateProp::state> &s,
    const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>> LdmLoadsImmediateProp::set_reg(
    const std::shared_ptr<LdmLoadsImmediateProp::state> &s,
    const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int LdmLoadsImmediateProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int LdmLoadsImmediateProp::get_pair(
    const std::shared_ptr<LdmLoadsImmediateProp::state> &s,
    const unsigned int r) {
...
std::shared_ptr<List<unsigned int>> LdmLoadsImmediateProp::set_pair(
    const std::shared_ptr<LdmLoadsImmediateProp::state> &s,
    const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>> LdmLoadsImmediateProp::push_return(
    std::shared_ptr<LdmLoadsImmediateProp::state> s, const unsigned int ret) {
  return List<unsigned int>::ctor::cons_((std::move(ret) % 4096u),
                                         std::move(s)->ex_stack)
      ->firstn(2u);
}

std::shared_ptr<LdmLoadsImmediateProp::state> LdmLoadsImmediateProp::execute(
    std::shared_ptr<LdmLoadsImmediateProp::state> s,
    const std::shared_ptr<LdmLoadsImmediateProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename LdmLoadsImmediateProp::instr::NOP _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename LdmLoadsImmediateProp::instr::LDM _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename LdmLoadsImmediateProp::instr::LD _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::XCH _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename LdmLoadsImmediateProp::instr::INC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::ADD _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename LdmLoadsImmediateProp::instr::SUB _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename LdmLoadsImmediateProp::instr::IAC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::DAC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::CLC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename LdmLoadsImmediateProp::instr::STC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename LdmLoadsImmediateProp::instr::CMC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::CMA _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::CLB _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename LdmLoadsImmediateProp::instr::RAL _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::RAR _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::TCC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::TCS _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::DAA _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::KBP _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::JUN _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::JMS _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename LdmLoadsImmediateProp::instr::JCN _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
          ...
          [&](const typename LdmLoadsImmediateProp::instr::FIM _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename LdmLoadsImmediateProp::instr::SRC _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename LdmLoadsImmediateProp::instr::FIN _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(
          ...
          [&](const typename LdmLoadsImmediateProp::instr::JIN _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<LdmLoadsImmediateProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename LdmLoadsImmediateProp::instr::ISZ _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename LdmLoadsImmediateProp::instr::BBL _args)
              -> std::shared_ptr<LdmLoadsImmediateProp::state> {
