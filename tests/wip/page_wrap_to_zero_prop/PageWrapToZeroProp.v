...
(* Behavioral candidate: addr12_of_nat wraps the first overflowing page boundary back to zero. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PageWrapToZeroProp.
...
Definition t : Prop :=
  addr12_of_nat 4096 = 0.

End PageWrapToZeroProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "page_wrap_to_zero_prop" PageWrapToZeroProp.
