...
(* Behavioral candidate: ram_write_status_sys preserves WF_bank across the RAM system. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module RamWriteStatusSysPreservesWfBankProp.
...
Definition t : Prop :=
  Forall WF_bank (ram_write_status_sys init_state 2 7).

End RamWriteStatusSysPreservesWfBankProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "ram_write_status_sys_preserves_wf_bank_prop" RamWriteStatusSysPreservesWfBankProp.
