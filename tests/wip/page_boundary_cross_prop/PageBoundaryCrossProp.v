...
(* Behavioral candidate: adding two at offset 254 crosses to the next page. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PageBoundaryCrossProp.
...
Definition t : Prop :=
  page_of (addr12_of_nat (p_cross_254 + 2)) = 1.

End PageBoundaryCrossProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "page_boundary_cross_prop" PageBoundaryCrossProp.
