...
(* Behavioral candidate: execute preserves WF for SRC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteSrcWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (SRC 6) /\
  WF (execute sample (SRC 6)).

End ExecuteSrcWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_src_wf_prop" ExecuteSrcWfProp.
