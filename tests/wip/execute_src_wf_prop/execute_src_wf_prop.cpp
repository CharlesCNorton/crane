...
unsigned int
ExecuteSrcWfProp::get_reg(const std::shared_ptr<ExecuteSrcWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteSrcWfProp::set_reg(const std::shared_ptr<ExecuteSrcWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteSrcWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteSrcWfProp::get_pair(const std::shared_ptr<ExecuteSrcWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteSrcWfProp::set_pair(const std::shared_ptr<ExecuteSrcWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteSrcWfProp::push_return(std::shared_ptr<ExecuteSrcWfProp::state> s,
...
std::shared_ptr<ExecuteSrcWfProp::state>
ExecuteSrcWfProp::execute(std::shared_ptr<ExecuteSrcWfProp::state> s,
                          const std::shared_ptr<ExecuteSrcWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteSrcWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteSrcWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteSrcWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteSrcWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteSrcWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteSrcWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteSrcWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteSrcWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteSrcWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteSrcWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteSrcWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteSrcWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteSrcWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
          ...
          [&](const typename ExecuteSrcWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteSrcWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteSrcWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(
          ...
          [&](const typename ExecuteSrcWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteSrcWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteSrcWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteSrcWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteSrcWfProp::state> {
