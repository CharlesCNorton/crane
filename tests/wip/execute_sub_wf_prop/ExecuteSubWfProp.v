...
(* Behavioral candidate: execute preserves WF for SUB. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteSubWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (SUB 3) /\
  WF (execute sample (SUB 3)).

End ExecuteSubWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_sub_wf_prop" ExecuteSubWfProp.
