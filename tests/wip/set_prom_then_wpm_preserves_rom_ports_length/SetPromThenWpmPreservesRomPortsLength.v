...
(* Behavioral candidate: set_prom then WPM preserves ROM port count. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module SetPromThenWpmPreservesRomPortsLength.
...
Definition t : bool := Nat.eqb (length (rom_ports after)) 4.

End SetPromThenWpmPreservesRomPortsLength.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "set_prom_then_wpm_preserves_rom_ports_length" SetPromThenWpmPreservesRomPortsLength.
