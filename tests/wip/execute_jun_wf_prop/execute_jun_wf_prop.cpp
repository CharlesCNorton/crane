...
unsigned int
ExecuteJunWfProp::get_reg(const std::shared_ptr<ExecuteJunWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteJunWfProp::set_reg(const std::shared_ptr<ExecuteJunWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteJunWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteJunWfProp::get_pair(const std::shared_ptr<ExecuteJunWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteJunWfProp::set_pair(const std::shared_ptr<ExecuteJunWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteJunWfProp::push_return(std::shared_ptr<ExecuteJunWfProp::state> s,
...
std::shared_ptr<ExecuteJunWfProp::state>
ExecuteJunWfProp::execute(std::shared_ptr<ExecuteJunWfProp::state> s,
                          const std::shared_ptr<ExecuteJunWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteJunWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJunWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteJunWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJunWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteJunWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteJunWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJunWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJunWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJunWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJunWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            return std::make_shared<ExecuteJunWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJunWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteJunWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteJunWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
          ...
          [&](const typename ExecuteJunWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJunWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteJunWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(
          ...
          [&](const typename ExecuteJunWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJunWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteJunWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteJunWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteJunWfProp::state> {
