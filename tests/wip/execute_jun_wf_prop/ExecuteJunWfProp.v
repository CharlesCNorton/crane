...
(* Behavioral candidate: execute preserves WF for JUN. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteJunWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (JUN 1024) /\
  WF (execute sample (JUN 1024)).

End ExecuteJunWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_jun_wf_prop" ExecuteJunWfProp.
