...
unsigned int
ExecuteClbWfProp::get_reg(const std::shared_ptr<ExecuteClbWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteClbWfProp::set_reg(const std::shared_ptr<ExecuteClbWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteClbWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteClbWfProp::get_pair(const std::shared_ptr<ExecuteClbWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteClbWfProp::set_pair(const std::shared_ptr<ExecuteClbWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteClbWfProp::push_return(std::shared_ptr<ExecuteClbWfProp::state> s,
...
std::shared_ptr<ExecuteClbWfProp::state>
ExecuteClbWfProp::execute(std::shared_ptr<ExecuteClbWfProp::state> s,
                          const std::shared_ptr<ExecuteClbWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteClbWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClbWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteClbWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteClbWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteClbWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteClbWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClbWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClbWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteClbWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteClbWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            return std::make_shared<ExecuteClbWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteClbWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteClbWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteClbWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
          ...
          [&](const typename ExecuteClbWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteClbWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteClbWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(
          ...
          [&](const typename ExecuteClbWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteClbWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteClbWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteClbWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteClbWfProp::state> {
