...
(* Behavioral candidate: execute preserves WF for CLB. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteClbWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample CLB).

End ExecuteClbWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_clb_wf_prop" ExecuteClbWfProp.
