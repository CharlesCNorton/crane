...
(* Behavioral candidate: push_return keeps the stack length within the concrete two-cell window. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PushReturnLenProp.
...
Definition t : Prop :=
  length (push_return sample 77) <= 2.

End PushReturnLenProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "push_return_len_prop" PushReturnLenProp.
