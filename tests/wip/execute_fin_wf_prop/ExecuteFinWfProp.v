...
(* Behavioral candidate: execute preserves WF for FIN. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteFinWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (FIN 8) /\
  WF (execute sample (FIN 8)).

End ExecuteFinWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_fin_wf_prop" ExecuteFinWfProp.
