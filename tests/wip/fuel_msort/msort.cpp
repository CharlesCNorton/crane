...
MergeSort::split(const std::shared_ptr<List<unsigned int>> &l) {
  return std::visit(
      Overloaded{
...
std::shared_ptr<List<unsigned int>>
MergeSort::merge(std::shared_ptr<List<unsigned int>> l1,
...
std::shared_ptr<List<unsigned int>>
MergeSort::msort(const std::shared_ptr<List<unsigned int>> &l) {
