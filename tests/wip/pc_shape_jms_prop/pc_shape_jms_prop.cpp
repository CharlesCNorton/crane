...
unsigned int
PcShapeJmsProp::get_reg(const std::shared_ptr<PcShapeJmsProp::state> &s,
                        const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PcShapeJmsProp::set_reg(const std::shared_ptr<PcShapeJmsProp::state> &s,
                        const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeJmsProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PcShapeJmsProp::get_pair(const std::shared_ptr<PcShapeJmsProp::state> &s,
                         const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PcShapeJmsProp::set_pair(const std::shared_ptr<PcShapeJmsProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PcShapeJmsProp::push_return(std::shared_ptr<PcShapeJmsProp::state> s,
...
std::shared_ptr<PcShapeJmsProp::state>
PcShapeJmsProp::execute(std::shared_ptr<PcShapeJmsProp::state> s,
                        const std::shared_ptr<PcShapeJmsProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeJmsProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJmsProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeJmsProp::instr::LD _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJmsProp::instr::INC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeJmsProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeJmsProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJmsProp::instr::STC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJmsProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJmsProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJmsProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            return std::make_shared<PcShapeJmsProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJmsProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeJmsProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeJmsProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
          ...
          [&](const typename PcShapeJmsProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJmsProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeJmsProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(
          ...
          [&](const typename PcShapeJmsProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJmsProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeJmsProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeJmsProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeJmsProp::state> {
