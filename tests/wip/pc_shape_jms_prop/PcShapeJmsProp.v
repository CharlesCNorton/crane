...
(* Behavioral candidate: JMS sets the PC to its concrete target. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeJmsProp.
...
Definition t : Prop :=
  ex_pc (execute sample (JMS 2048)) = 2048.

End PcShapeJmsProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_jms_prop" PcShapeJmsProp.
