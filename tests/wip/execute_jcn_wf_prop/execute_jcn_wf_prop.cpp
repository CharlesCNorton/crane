...
unsigned int
ExecuteJcnWfProp::get_reg(const std::shared_ptr<ExecuteJcnWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteJcnWfProp::set_reg(const std::shared_ptr<ExecuteJcnWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteJcnWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteJcnWfProp::get_pair(const std::shared_ptr<ExecuteJcnWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteJcnWfProp::set_pair(const std::shared_ptr<ExecuteJcnWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteJcnWfProp::push_return(std::shared_ptr<ExecuteJcnWfProp::state> s,
...
std::shared_ptr<ExecuteJcnWfProp::state>
ExecuteJcnWfProp::execute(std::shared_ptr<ExecuteJcnWfProp::state> s,
                          const std::shared_ptr<ExecuteJcnWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteJcnWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJcnWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteJcnWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJcnWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteJcnWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteJcnWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJcnWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJcnWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteJcnWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJcnWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteJcnWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteJcnWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteJcnWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
          ...
          [&](const typename ExecuteJcnWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteJcnWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteJcnWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(
          ...
          [&](const typename ExecuteJcnWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteJcnWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteJcnWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteJcnWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteJcnWfProp::state> {
