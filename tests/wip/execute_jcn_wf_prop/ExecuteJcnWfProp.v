...
(* Behavioral candidate: execute preserves WF for JCN. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteJcnWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (JCN 2 17) /\
  WF (execute sample (JCN 2 17)).

End ExecuteJcnWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_jcn_wf_prop" ExecuteJcnWfProp.
