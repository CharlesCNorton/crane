...
(* Behavioral candidate: execute preserves WF for TCC. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteTccWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample TCC).

End ExecuteTccWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_tcc_wf_prop" ExecuteTccWfProp.
