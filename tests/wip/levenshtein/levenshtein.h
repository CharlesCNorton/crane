...
T1 projT1(const std::shared_ptr<sigT::sigT<T1, T2>> x) {
  return std::visit(Overloaded{[&](const sigT::existT<T1, T2> _args) -> T1 {
                      T1 a = _args._a0;
                      return a;
                    }},
                    *x);
...
struct Ascii {
  ...
  make(std::shared_ptr<bool0::bool0> _a0, std::shared_ptr<bool0::bool0> _a1,
...
struct String {
  ...
  static std::shared_ptr<string> make(std::shared_ptr<ascii::ascii> _a0,
                                      std::shared_ptr<string> _a1);
};
}; // namespace string
...
struct insertion {
  ...
  static std::shared_ptr<edit> make(std::shared_ptr<ascii::ascii> _a0,
                                    std::shared_ptr<string::string> _a1);
};
struct deletion {
  std::shared_ptr<ascii::ascii> _a0;
...
struct skip {
  ...
  static std::shared_ptr<chain> make(std::shared_ptr<ascii::ascii> _a0,
                                     std::shared_ptr<string::string> _a1,
                                     std::shared_ptr<string::string> _a2,
                                     std::shared_ptr<nat::nat> _a3,
                                     std::shared_ptr<chain> _a4);
...
struct change {
  ...
  make(std::shared_ptr<string::string> _a0, std::shared_ptr<string::string> _a1,
       std::shared_ptr<string::string> _a2, std::shared_ptr<nat::nat> _a3,
       std::shared_ptr<edit::edit> _a4, std::shared_ptr<chain> _a5);
};
}; // namespace chain
...
T1 min3_app(const T1 x, const T1 y, const T1 z, F3 &&f) {
  ...
  return std::visit(
      Overloaded{
          [&](const bool0::true0 _args) -> T1 {
            return std::visit(
                Overloaded{[&](const bool0::true0 _args) -> T1 { return x; },
                           [&](const bool0::false0 _args) -> T1 { return z; }},
                *leb(n1, n3));
          },
          [&](const bool0::false0 _args) -> T1 {
            return std::visit(
                Overloaded{[&](const bool0::true0 _args) -> T1 { return y; },
                           [&](const bool0::false0 _args) -> T1 { return z; }},
                *leb(n2, n3));
          }},
      *leb(n1, n2));
