...
#include <cassert>
#include <functional>
#include <instr_wf_ldm_five_prop.h>
#include <iostream>
#include <memory>
#include <optional>
#include <stdexcept>
...
unsigned int
InstrWfLdmFiveProp::get_reg(const std::shared_ptr<InstrWfLdmFiveProp::state> &s,
                            const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
InstrWfLdmFiveProp::set_reg(const std::shared_ptr<InstrWfLdmFiveProp::state> &s,
                            const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int InstrWfLdmFiveProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int InstrWfLdmFiveProp::get_pair(
    const std::shared_ptr<InstrWfLdmFiveProp::state> &s, const unsigned int r) {
  unsigned int base = pair_base(r);
  return (((get_reg(s, base) % 16u) * 16u) + (get_reg(s, (base + 1)) % 16u));
}

std::shared_ptr<List<unsigned int>> InstrWfLdmFiveProp::set_pair(
    const std::shared_ptr<InstrWfLdmFiveProp::state> &s, const unsigned int r,
...
std::shared_ptr<List<unsigned int>>
InstrWfLdmFiveProp::push_return(std::shared_ptr<InstrWfLdmFiveProp::state> s,
...
std::shared_ptr<InstrWfLdmFiveProp::state> InstrWfLdmFiveProp::execute(
    std::shared_ptr<InstrWfLdmFiveProp::state> s,
    const std::shared_ptr<InstrWfLdmFiveProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename InstrWfLdmFiveProp::instr::NOP _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename InstrWfLdmFiveProp::instr::LDM _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename InstrWfLdmFiveProp::instr::LD _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::XCH _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename InstrWfLdmFiveProp::instr::INC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::ADD _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename InstrWfLdmFiveProp::instr::SUB _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename InstrWfLdmFiveProp::instr::IAC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::DAC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::CLC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename InstrWfLdmFiveProp::instr::STC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename InstrWfLdmFiveProp::instr::CMC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::CMA _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::CLB _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename InstrWfLdmFiveProp::instr::RAL _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::RAR _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::TCC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::TCS _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::DAA _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::KBP _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::JUN _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::JMS _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename InstrWfLdmFiveProp::instr::JCN _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
          ...
          [&](const typename InstrWfLdmFiveProp::instr::FIM _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename InstrWfLdmFiveProp::instr::SRC _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename InstrWfLdmFiveProp::instr::FIN _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(
          ...
          [&](const typename InstrWfLdmFiveProp::instr::JIN _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<InstrWfLdmFiveProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename InstrWfLdmFiveProp::instr::ISZ _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename InstrWfLdmFiveProp::instr::BBL _args)
              -> std::shared_ptr<InstrWfLdmFiveProp::state> {
