...
(* Behavioral candidate: JCN with false carry falls through by two. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeJcnNotTakenProp.
...
Definition t : Prop :=
  ex_pc (execute sample (JCN 1 17)) = (ex_pc sample + 2) mod 4096.

End PcShapeJcnNotTakenProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_jcn_not_taken_prop" PcShapeJcnNotTakenProp.
