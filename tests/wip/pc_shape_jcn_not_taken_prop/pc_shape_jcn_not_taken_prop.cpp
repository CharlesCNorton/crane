...
#include <memory>
#include <optional>
#include <pc_shape_jcn_not_taken_prop.h>
#include <stdexcept>
#include <string>
#include <utility>
#include <variant>

unsigned int PcShapeJcnNotTakenProp::get_reg(
    const std::shared_ptr<PcShapeJcnNotTakenProp::state> &s,
    const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>> PcShapeJcnNotTakenProp::set_reg(
    const std::shared_ptr<PcShapeJcnNotTakenProp::state> &s,
    const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeJcnNotTakenProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int PcShapeJcnNotTakenProp::get_pair(
    const std::shared_ptr<PcShapeJcnNotTakenProp::state> &s,
    const unsigned int r) {
...
std::shared_ptr<List<unsigned int>> PcShapeJcnNotTakenProp::set_pair(
    const std::shared_ptr<PcShapeJcnNotTakenProp::state> &s,
    const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>> PcShapeJcnNotTakenProp::push_return(
    std::shared_ptr<PcShapeJcnNotTakenProp::state> s, const unsigned int ret) {
  return List<unsigned int>::ctor::cons_((std::move(ret) % 4096u),
                                         std::move(s)->ex_stack)
      ->firstn(2u);
}

std::shared_ptr<PcShapeJcnNotTakenProp::state> PcShapeJcnNotTakenProp::execute(
    std::shared_ptr<PcShapeJcnNotTakenProp::state> s,
    const std::shared_ptr<PcShapeJcnNotTakenProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeJcnNotTakenProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnNotTakenProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeJcnNotTakenProp::instr::LD _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::INC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnNotTakenProp::instr::STC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnNotTakenProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJcnNotTakenProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJcnNotTakenProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeJcnNotTakenProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeJcnNotTakenProp::state> {
