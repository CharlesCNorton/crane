...
(* Behavioral candidate: execute preserves WF for DAA. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteDaaWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample DAA).

End ExecuteDaaWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_daa_wf_prop" ExecuteDaaWfProp.
