...
unsigned int
ExecuteDaaWfProp::get_reg(const std::shared_ptr<ExecuteDaaWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteDaaWfProp::set_reg(const std::shared_ptr<ExecuteDaaWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteDaaWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteDaaWfProp::get_pair(const std::shared_ptr<ExecuteDaaWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteDaaWfProp::set_pair(const std::shared_ptr<ExecuteDaaWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteDaaWfProp::push_return(std::shared_ptr<ExecuteDaaWfProp::state> s,
...
std::shared_ptr<ExecuteDaaWfProp::state>
ExecuteDaaWfProp::execute(std::shared_ptr<ExecuteDaaWfProp::state> s,
                          const std::shared_ptr<ExecuteDaaWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteDaaWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDaaWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteDaaWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteDaaWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteDaaWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteDaaWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDaaWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDaaWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteDaaWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteDaaWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteDaaWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteDaaWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteDaaWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
          ...
          [&](const typename ExecuteDaaWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteDaaWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteDaaWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(
          ...
          [&](const typename ExecuteDaaWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteDaaWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteDaaWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteDaaWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteDaaWfProp::state> {
