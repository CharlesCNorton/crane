...
(* Behavioral candidate: execute preserves WF for RAL. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteRalWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample RAL).

End ExecuteRalWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_ral_wf_prop" ExecuteRalWfProp.
