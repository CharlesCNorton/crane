...
unsigned int
ExecuteRalWfProp::get_reg(const std::shared_ptr<ExecuteRalWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteRalWfProp::set_reg(const std::shared_ptr<ExecuteRalWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteRalWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteRalWfProp::get_pair(const std::shared_ptr<ExecuteRalWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteRalWfProp::set_pair(const std::shared_ptr<ExecuteRalWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteRalWfProp::push_return(std::shared_ptr<ExecuteRalWfProp::state> s,
...
std::shared_ptr<ExecuteRalWfProp::state>
ExecuteRalWfProp::execute(std::shared_ptr<ExecuteRalWfProp::state> s,
                          const std::shared_ptr<ExecuteRalWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteRalWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRalWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteRalWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteRalWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteRalWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteRalWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRalWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRalWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteRalWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteRalWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            return std::make_shared<ExecuteRalWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteRalWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteRalWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteRalWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
          ...
          [&](const typename ExecuteRalWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteRalWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteRalWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(
          ...
          [&](const typename ExecuteRalWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteRalWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteRalWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteRalWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteRalWfProp::state> {
