...
(* Behavioral candidate: BBL pops one frame from the concrete sample stack. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module BblPopsStackProp.
...
Definition t : Prop :=
  length (ex_stack (execute sample (BBL 7))) = 1.

End BblPopsStackProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "bbl_pops_stack_prop" BblPopsStackProp.
