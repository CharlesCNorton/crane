...
(* Behavioral candidate: execute preserves WF for NOP. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteNopWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample NOP).

End ExecuteNopWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_nop_wf_prop" ExecuteNopWfProp.
