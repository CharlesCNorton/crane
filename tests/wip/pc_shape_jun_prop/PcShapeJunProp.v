...
(* Behavioral candidate: JUN sets the PC to its concrete target. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module PcShapeJunProp.
...
Definition t : Prop :=
  ex_pc (execute sample (JUN 1024)) = 1024.

End PcShapeJunProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "pc_shape_jun_prop" PcShapeJunProp.
