...
unsigned int
PcShapeJunProp::get_reg(const std::shared_ptr<PcShapeJunProp::state> &s,
                        const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
PcShapeJunProp::set_reg(const std::shared_ptr<PcShapeJunProp::state> &s,
                        const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int PcShapeJunProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
PcShapeJunProp::get_pair(const std::shared_ptr<PcShapeJunProp::state> &s,
                         const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
PcShapeJunProp::set_pair(const std::shared_ptr<PcShapeJunProp::state> &s,
                         const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
PcShapeJunProp::push_return(std::shared_ptr<PcShapeJunProp::state> s,
...
std::shared_ptr<PcShapeJunProp::state>
PcShapeJunProp::execute(std::shared_ptr<PcShapeJunProp::state> s,
                        const std::shared_ptr<PcShapeJunProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename PcShapeJunProp::instr::NOP _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJunProp::instr::LDM _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename PcShapeJunProp::instr::LD _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::XCH _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJunProp::instr::INC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::ADD _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename PcShapeJunProp::instr::SUB _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename PcShapeJunProp::instr::IAC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::DAC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::CLC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJunProp::instr::STC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJunProp::instr::CMC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::CMA _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::CLB _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename PcShapeJunProp::instr::RAL _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::RAR _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::TCC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJunProp::instr::TCS _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            return std::make_shared<PcShapeJunProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename PcShapeJunProp::instr::DAA _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename PcShapeJunProp::instr::KBP _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::JUN _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::JMS _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename PcShapeJunProp::instr::JCN _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
          ...
          [&](const typename PcShapeJunProp::instr::FIM _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename PcShapeJunProp::instr::SRC _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename PcShapeJunProp::instr::FIN _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(
          ...
          [&](const typename PcShapeJunProp::instr::JIN _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<PcShapeJunProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename PcShapeJunProp::instr::ISZ _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename PcShapeJunProp::instr::BBL _args)
              -> std::shared_ptr<PcShapeJunProp::state> {
