...
(* Behavioral candidate: execute preserves WF for KBP. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteKbpWfProp.
...
Definition t : Prop :=
  WF sample /\
  WF (execute sample KBP).

End ExecuteKbpWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_kbp_wf_prop" ExecuteKbpWfProp.
