...
unsigned int
ExecuteKbpWfProp::get_reg(const std::shared_ptr<ExecuteKbpWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteKbpWfProp::set_reg(const std::shared_ptr<ExecuteKbpWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteKbpWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteKbpWfProp::get_pair(const std::shared_ptr<ExecuteKbpWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteKbpWfProp::set_pair(const std::shared_ptr<ExecuteKbpWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteKbpWfProp::push_return(std::shared_ptr<ExecuteKbpWfProp::state> s,
...
std::shared_ptr<ExecuteKbpWfProp::state>
ExecuteKbpWfProp::execute(std::shared_ptr<ExecuteKbpWfProp::state> s,
                          const std::shared_ptr<ExecuteKbpWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteKbpWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteKbpWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteKbpWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteKbpWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteKbpWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteKbpWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteKbpWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteKbpWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteKbpWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteKbpWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteKbpWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteKbpWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteKbpWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
          ...
          [&](const typename ExecuteKbpWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteKbpWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteKbpWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(
          ...
          [&](const typename ExecuteKbpWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteKbpWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteKbpWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteKbpWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteKbpWfProp::state> {
