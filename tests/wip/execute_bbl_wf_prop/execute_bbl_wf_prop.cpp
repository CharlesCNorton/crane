...
unsigned int
ExecuteBblWfProp::get_reg(const std::shared_ptr<ExecuteBblWfProp::state> &s,
                          const unsigned int r) {
  return s->ex_regs->nth(r, 0u);
}

std::shared_ptr<List<unsigned int>>
ExecuteBblWfProp::set_reg(const std::shared_ptr<ExecuteBblWfProp::state> &s,
                          const unsigned int r, const unsigned int v) {
  return update_nth<unsigned int>(r, (v % 16u), s->ex_regs);
}

unsigned int ExecuteBblWfProp::pair_base(const unsigned int r) {
  return (((r - (r % 2u)) > r ? 0 : (r - (r % 2u))));
}

unsigned int
ExecuteBblWfProp::get_pair(const std::shared_ptr<ExecuteBblWfProp::state> &s,
                           const unsigned int r) {
...
std::shared_ptr<List<unsigned int>>
ExecuteBblWfProp::set_pair(const std::shared_ptr<ExecuteBblWfProp::state> &s,
                           const unsigned int r, const unsigned int v) {
  unsigned int base = pair_base(r);
...
std::shared_ptr<List<unsigned int>>
ExecuteBblWfProp::push_return(std::shared_ptr<ExecuteBblWfProp::state> s,
...
std::shared_ptr<ExecuteBblWfProp::state>
ExecuteBblWfProp::execute(std::shared_ptr<ExecuteBblWfProp::state> s,
                          const std::shared_ptr<ExecuteBblWfProp::instr> &i) {
  return std::visit(
      Overloaded{
          [&](const typename ExecuteBblWfProp::instr::NOP _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
                s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteBblWfProp::instr::LDM _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int n = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(
                state{(std::move(n) % 16u), s->ex_regs, s->ex_carry,
                      ((s->ex_pc + 1u) % 4096u), s->ex_stack, s->ex_pair_bus,
                      s->ex_ports});
          },
          [&](const typename ExecuteBblWfProp::instr::LD _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::XCH _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteBblWfProp::instr::INC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::ADD _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int sum =
          ...
          [&](const typename ExecuteBblWfProp::instr::SUB _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int diff =
          ...
          [&](const typename ExecuteBblWfProp::instr::IAC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::DAC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::CLC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
                state{s->ex_acc, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteBblWfProp::instr::STC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
                state{s->ex_acc, s->ex_regs, true, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteBblWfProp::instr::CMC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::CMA _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::CLB _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
                state{0u, s->ex_regs, false, ((s->ex_pc + 1u) % 4096u),
                      s->ex_stack, s->ex_pair_bus, s->ex_ports});
          },
          [&](const typename ExecuteBblWfProp::instr::RAL _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::RAR _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::TCC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteBblWfProp::instr::TCS _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            return std::make_shared<ExecuteBblWfProp::state>(
                state{[&](void) {
                        if (s->ex_carry) {
          ...
          [&](const typename ExecuteBblWfProp::instr::DAA _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int acc_;
            if ((10u <= (s->ex_acc + 1))) {
          ...
          [&](const typename ExecuteBblWfProp::instr::KBP _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::JUN _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::JMS _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int a = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, (std::move(a) % 4096u),
          ...
          [&](const typename ExecuteBblWfProp::instr::JCN _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
          ...
          [&](const typename ExecuteBblWfProp::instr::FIM _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
          ...
          [&](const typename ExecuteBblWfProp::instr::SRC _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(state{
                s->ex_acc, s->ex_regs, s->ex_carry, ((s->ex_pc + 1u) % 4096u),
          ...
          [&](const typename ExecuteBblWfProp::instr::FIN _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(
          ...
          [&](const typename ExecuteBblWfProp::instr::JIN _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            return std::make_shared<ExecuteBblWfProp::state>(
                state{s->ex_acc, s->ex_regs, s->ex_carry,
          ...
          [&](const typename ExecuteBblWfProp::instr::ISZ _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
            unsigned int r = _args._a0;
            unsigned int a = _args._a1;
          ...
          [&](const typename ExecuteBblWfProp::instr::BBL _args)
              -> std::shared_ptr<ExecuteBblWfProp::state> {
