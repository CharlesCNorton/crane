...
(* Behavioral candidate: execute preserves WF for BBL. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecuteBblWfProp.
...
Definition t : Prop :=
  WF sample /\
  instr_wf (BBL 7) /\
  WF (execute sample (BBL 7)).

End ExecuteBblWfProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_bbl_wf_prop" ExecuteBblWfProp.
