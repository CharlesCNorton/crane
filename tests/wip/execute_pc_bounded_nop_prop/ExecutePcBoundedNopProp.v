...
(* Behavioral candidate: execute keeps PC bounded for NOP on the sample state. *)

From Stdlib Require Import List Nat Bool.
Import ListNotations.

Module ExecutePcBoundedNopProp.
...
Definition t : Prop :=
  ex_pc (execute sample NOP) < 4096.

End ExecutePcBoundedNopProp.

Require Crane.Extraction.
From Crane Require Mapping.Std Mapping.NatIntStd.
Crane Extraction "execute_pc_bounded_nop_prop" ExecutePcBoundedNopProp.
